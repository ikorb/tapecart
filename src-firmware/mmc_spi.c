/*-----------------------------------------------------------------------*/
/* MMCv3/SDv1/SDv2 Controls via SPI module                               */
/*-----------------------------------------------------------------------*/
/*
...
#define CS_LOW()		spi_set_ss(SPISS_LOW)   /* Set MMC_CS = low */
#define	CS_HIGH()		spi_set_ss(SPISS_HIGH)  /* Set MMC_CS = high */
...
#define	FCLK_SLOW()		spi_clk_slow()          /* Set SPI clock for initialization (100-400kHz) */
#define	FCLK_FAST()		spi_clk_fast()          /* Set SPI clock for read/write (20MHz max) */
...
/* Exchange a byte */
#define xchg_spi(byte) spi_exchange_byte(byte)
...
)
{
	...
	case CTRL_TRIM:		/* Erase a block of sectors (used when _USE_TRIM in ffconf.h is 1) */
		...
		break;
#endif
#if 0   /* Following commands are never used by FatFs module */
